...
if($axc0=='mostrar'){
	...
	$consulta_num_on = $cnnx4s->query($query_num_on) or die ("Falló num de instancias " . $query_num_on);
	...
	$consulta_num_ovh = $cnnx4s->query($query_num_ovh) or die ("Falló num de instancias OVH " . $query_num_ovh);

	$query_num_codero = "SELECT activa_instancia FROM b64_instancias WHERE servidor_instancia = 'Codero'";
	$consulta_num_codero = $cnnx4s->query($query_num_codero) or die ("Falló num de instancias Codero " . $query_num_codero);

	$query_num_jup = "SELECT activa_instancia FROM b64_instancias WHERE servidor_instancia = 'Jupiter'";
	$consulta_num_jup = $cnnx4s->query($query_num_jup) or die ("Falló num de instancias Jupiter " . $query_num_jup);
...
if($axc0=='activas'){
	...
	$consulta_num_off = $cnnx4s->query($query_num_off) or die ("Falló num de instancias " . $query_num_off);
...
if($axc0=='codero'){
	...
	$consulta_num = $cnnx4s->query($query_num) or die ("Falló num de instancias Codero " . $query_num);
...
if($axc0=='ovh'){
	...
	$query_num_codero = "SELECT activa_instancia FROM b64_instancias WHERE servidor_instancia = 'Codero'";
	$consulta_num_codero = $cnnx4s->query($query_num_codero) or die ("Falló num de instancias OVH " . $query_num_codero);
...
if($axc0=='jupiter'){
	...
	$query_num_ovh = "SELECT activa_instancia FROM b64_instancias WHERE servidor_instancia = 'OVH'";
	$consulta_num_ovh = $cnnx4s->query($query_num_ovh) or die ("Falló num de instancias Jupiter " . $query_num_ovh);
