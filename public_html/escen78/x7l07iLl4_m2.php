                              ...
                              <div class="card card-widget widget-user shadow">
                                ...
                                <div class="btn-group">
                                  <?php if(v4lID44x50("1200-004", $u5u4i0) == TRUE){ ?>
                                    <a href="v75t4?axc0=eMpr35As&flo0=<?= $eCry($u5h34r5['zID7']) ?>" type="button" class="btn btn-info btn-flat" style="width: 100%;"><i class="fad fa-eye"></i> Ver</a>
                                  <?php } ?>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div class="col">
                                          ...
                                          <?php if(v4lID44x50("1200-004", $u5u4i0) == TRUE){ ?>
                                            <a href="v75t4?axc0=eMpr35As&flo0=<?= $eCry($u5h34r5['zID7']) ?>" type="button" class="btn btn-info btn-flat btn-xs" ><i class="fad fa-eye"></i> Ver</a>
                                          <?php } ?>
