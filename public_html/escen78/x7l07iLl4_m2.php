                              ...
                              <div class="card card-widget widget-user shadow">
                                ...
                                <div class="btn-group">
                                  <?php if(v4lID44x50("1200-004", $u5u4i0) == TRUE){ ?>
                                    <a href="v75t4?axc0=eMpr35As&flo0=<?= $eCry($u5h34r5['zID7']) ?>" type="button" class="btn btn-info btn-flat" style="width: 100%;"><i class="fa-duotone fa-eye"></i> Ver</a>
                                  <?php } ?>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <p style="margin: 0;" class="corta-texto">
                                        ...
                                        <?php $i = 0; 
                                              foreach ($u5h34r5['3mP'] as $key => $value) { ?>
                                          <?php if($i <= 2){ ?>    
                                            <a href="v75t4?axc0=v3hiXs&eMpr3=<?= $eCry($value['nn']) ?>"><span class="right badge badge-info"><?= $value['nm'] ?></span></a>
                                          <?php $i++;
                                                  } ?>
                                        <?php } $i =0;?>
                                      </p>
                                    ...
                                    <td>
                                      <div class="col">
                                          ...
                                          <?php if(v4lID44x50("1200-004", $u5u4i0) == TRUE){ ?>
                                            <a href="v75t4?axc0=eMpr35As&flo0=<?= $eCry($u5h34r5['zID7']) ?>" type="button" class="btn btn-info btn-flat btn-xs" ><i class="fa-duotone fa-eye"></i> Ver</a>
                                          <?php } ?>
