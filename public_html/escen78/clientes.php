<?php
include('iDi0m45/'.$iDi['u5h8ir5_iDi'].'/i_clientes.php');
        ...
        <div class="card-body p-0">
          <div class="btn-group" role="group">
            <?php if(isset($_SESSION['formCliente']) == true){ ?>
              ...
              <a href="ap4673i/clientes_api?accion=borrarFormulario" class="btn bg-gradient-danger btn-app" style="padding-top: 6px;" ><i class="fad fa-trash"></i> <?= eliminarFormulario ?></a>
      ...
      <div class="modal fade " id="modal-nuevo">
        <div class="modal-dialog ">
          <div class="modal-content <?= $brr4 ?> card-outline">
            <form method="POST" action="ap4673i/clientes_api?accion=procesaCliente" name="nuevoCliente" enctype="multipart/form-data">  
