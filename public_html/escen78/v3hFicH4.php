<?php
include('iDi0m45/'.$iDi['u5h8ir5_iDi'].'/i_v3hFicH4.php'); 
...
?>
    ...
    <section class="content">
                  ...
                  <table class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th><?= lbl_t4bnom ?></th>
                        <th><?= lbl_t4usu ?></th>               
                        <?php if(v4lID44x50("300-003", $u5u4i0) == TRUE){ /// --- EDITAR USUARIOS ?>
                      ...
                      <?php /// --- servicios ?> 
                        <?php foreach ($lds as $key => $value) { 
                          if($value['pd'] == true && $value['vnc'] == FALSE){
                            ...
                            $cf = 'color: red;';
                            $tx7 = 'Pendiente';
                            if(v4lID44x50("1300-100", $u5u4i0) == TRUE){
                          ...
                          elseif($value['pd'] == true && $value['vnc'] == TRUE){
                            ...
                            if(v4lID44x50("1300-102", $u5u4i0) == TRUE){
                ...
                <div class="card-body p-0">
                  <h3 class="profile-username text-center">
                    Archivo
                        ...
                        <tbody>
                          ...
                          foreach ($doxc as $xs4f => $P3r70y7) { 
                            ...
                            elseif(!array_key_exists($P3r70y7['c7ip0xS'], $D0c7ip0s)){ 
                              ...
                              $S005 = $cnnx4s->query($C005) or die ("Fallo al seleccionar categorias: ".$C005);
                              $ldss = [];
                      ...
                      <?php /*if(v4lID44x50("700-013", $u5u4i0) == TRUE){ /// --- AGREGAR docs ?>
              ...
              <form name="nuevo" method="post" action="ap4673i/v3hiCs_4pi.php?axc0=jHyytR3" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                  ...
                  <!--<input class="form-control" type="file" name="u5h8ir5_foto_add" ref="u5h8ir5_foto_add" id="u5h8ir5_foto_add" v-on:change="everImagen();">-->
                    ...
                    <input type="hidden" name="pp_xx007_add" value="<?= $u5u4i0 ?>">                    
              ...
              <form name="km" method="post" action="ap4673i/v3hFicH4_4pi.php?axc0=hY776">
                ...
                <div class="modal-body text-center">
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" name="pp_xx0102" value="<?= $u5u4i0 ?>">
                  </div>
            ...
            <div class="modal-content"> 
              <form name="cmb" method="post" action="ap4673i/v3hFicH4_4pi.php?axc0=hY778" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                  ...
                  <input type="hidden" name="frm_rgcmb008" id="frm_rgcmb008" value="<?= $u5u4i0 ?>">
      ...
      <?php //foreach ($ldd as $key => $value) {  /// --- DOCUMENTOS        ?>
              ...
              <div class="modal-content"> 
                <form name="nuevo" method="post" action="ap4673i/v3hFicH4_4pi.php?axc0=d0CvAdd" enctype="multipart/form-data">
                  ...
                  <div class="modal-body">
                    ...
                    <input type="hidden" name="agd_x008" id="agd_x008" value="<?= $u5u4i0 ?>" required>
        ...
        <?php }*/ ?>
        <?php /*if(v4lID44x50("1400-004", $u5u4i0) == TRUE){ ?>
                        ...
                        <div class="modal-body">
                          <?php if($value['xdDcFil'] != 'error2'){ ?>
                            <div style="text-align: center;">
                              ...
                              <a href="tmp/<?= $u5u4i0 ?>/<?= $value['xdDcFil'] ?>" class="btn btn-info btn-sm" target="_blank"><i class="fa-duotone fa-download"></i> Descargar</a>
                            </div>
                          <?php } ?>
                          <br>
      ...
      <?php foreach ($lds as $key => $value) { 
             // if($value['pd'] == true){
        ?>
              <?php if(v4lID44x50("1300-100", $u5u4i0) == TRUE){ ?>
                <!-- /.card -->
                      ...
                      <form name="nuevo" method="post" action="ap4673i/v3hFicH4_4pi.php?axc0=s3RvAdd" enctype="multipart/form-data"> 
                        ...
                        <div class="modal-body">
                          ...
                          <!--<input class="form-control" type="file" name="u5h8ir5_foto_add" ref="u5h8ir5_foto_add" id="u5h8ir5_foto_add" v-on:change="everImagen();">-->
                            ...
                            <input type="hidden" name="ags_x008" id="ags_x008" value="<?= $u5u4i0 ?>" required>
              ...
              <?php } ?>
              <?php if(v4lID44x50("1300-102", $u5u4i0) == TRUE){ ?>
                      ...
                      <form name="nuevo" method="post" action="ap4673i/v3hFicH4_4pi.php?axc0=s3RvAdd" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                          <?php if($value['xDcFil'] != 'error2'){ ?>
                            <div style="text-align: center;">
                              <i class="fa-duotone fa-file-invoice" style="color: #00bc8c; font-size: 5rem;"></i><br><br>
                              <a href="tmp/<?= $u5u4i0 ?>/<?= $value['xDcFil'] ?>" class="btn btn-info btn-sm" target="_blank"><i class="fa-duotone fa-download"></i> Descargar</a>
                            </div>
                          <?php } ?>
                          <br>
                            <table class="table table-hover table-head-fixed table-striped" id="example3">
