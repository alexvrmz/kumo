<?php
include('iDi0m45/'.$iDi['u5h8ir5_iDi'].'/i_d0cx6y.php');
      ...
      <div class="card <?= $brr4 ?> card-outline"> 
        ...
        <div class="card-body">
          ...
          <div class="card-body p-0">        
            <?php if(v4lID44x50("1400-100", $u5u4i0) == TRUE){ /// --- Agregar servicio?>
                    ...
                    foreach ($ls3r as $xs4f => $P3r70y7) { ?>                     
                      <tr>
                        ...
                        <?php if(v4lID44x50("1400-101", $u5u4i0) == TRUE){ /// --- Editar tramite tipo ?>
                          <td>
                              <a href="v75t4?axc0=Tr43Dt&pXRoI=<?= $eCry($P3r70y7['xDID']) ?>" class="btn btn-block bg-gradient-warning btn-xs"><i class="fa-duotone fa-edit"></i></a>
                          </td>
                        <?php } ?>
                      </tr>
                    <?php } ?>
