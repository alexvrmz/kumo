<?php
include('iDi0m45/'.$iDi['u5h8ir5_iDi'].'/i_emPr3Edi7.php');
    ...
    <div class="card <?= $brr4 ?> card-outline col-md-9">
      ...
      <div class="card-body">
        <div class="card-body p-0">         
          <a type="button" class="btn bg-gradient-success btn-app" style="padding-top: 6px;"href="v75t4?axc0=eMpr35As"><i class="fa-duotone fa-arrow-left"></i> <br><?= btn_46r364rU5u4ri0 ?></a>
        </div>
      </div>
    </div>
      <div class="card <?= $brr4 ?> card-outline col-md-9">
        <div class="card-header">
          <h3 class="profile-username text-center">Editando Empresa | <?= $xPxNICH ?></h3>  
        ...
        <!-- /.card-header -->
        <form method="POST" action="ap4673i/eMpr35As_4pi.php?axc0=sV3EMp">
          <div class="card-body">
            ...
            <input type="hidden" class="form-control" id="eMpr3" name="eMpr3" value="<?= $eMpr3 ?>" required>
