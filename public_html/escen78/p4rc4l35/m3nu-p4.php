    ...
    <ul class="navbar-nav ml-auto nav-child-indent">
      ...
      <li class="nav-item">
        <?php if($iDi['u5h8ir5_iDi'] == 'es_MX'){ ?>
          <a class="nav-link" href="ap4673i/c4r64iDi?accion=c02252&u5u4i0=<?= $u5u4i0 ?>&uh73Gg=<?= $_SERVER["REQUEST_URI"] ?>">
            <img src="dist/img/en_US.png" width="24px" height="auto" title="Switch to english">
          </a>
        <?php } elseif($iDi['u5h8ir5_iDi'] == 'en_US'){ ?>
          <a class="nav-link" href="ap4673i/c4r64iDi?accion=c02251&u5u4i0=<?= $u5u4i0 ?>&uh73Gg=<?= $_SERVER["REQUEST_URI"] ?>">
  ...
  <aside class="main-sidebar main-sidebar-custom <?= $iDi['config_sidebar'] ?> elevation-4">
    ...
    <div class="sidebar-custom">
      ...
      <a href="lgaccs25?accion=x002" class="btn btn-danger hide-on-collapse pos-right"><i class="fad fa-door-open"></i></a>
    </div>
  </aside>