<?php
include('iDi0m45/'.$iDi['u5h8ir5_iDi'].'/i_d0cx6yET.php');
    ...
    <div class="card <?= $brr4 ?> card-outline col-md-9">
      ...
      <div class="card-body">
        <div class="card-body p-0">         
          <a type="button" class="btn bg-gradient-success btn-app" style="padding-top: 6px;" href="v75t4?axc0=d0cx6y"><i class="fa-duotone fa-arrow-left"></i> <br><?= btn_46r364rU5u4ri0 ?></a>
        </div>
      </div>
    </div>
      <div class="card <?= $brr4 ?> card-outline col-md-9">
        ...
        <!-- /.card-header -->
        <form method="POST" action="ap4673i/d0cx6y_4pi?axc0=sV3Tr4">
          <div class="card-body">
