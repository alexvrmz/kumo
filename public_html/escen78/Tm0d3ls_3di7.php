<?php
include('iDi0m45/'.$iDi['u5h8ir5_iDi'].'/i_Tm0d3ls-3di7.php');
      ...
      <div class="card <?= $brr4 ?> card-outline col-lg-6">
        ...
        <div class="card-body">
          ...
          <form name="edit_user" method="post" action="ap4673i/Tm0d3ls_4pi.php?axc0=Tm0d3ls_9i45" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-12"> 
                  <?php if($u5h34r5['xBxMiMgu'] != ''){ ?>
                    <img src="dist/img/m0d3l0s/<?= $u5h34r5['xBxMiMgu'] ?>" alt="" class="img-fluid">
                  <?php }
                        else{ ?>
                    <img src="dist/img/m0d3l0s/0.png" alt="Sin Imagen" class="img-fluid">
                  <?php } ?>
                </div>
                <div class="col-12">
                  <div class="form-group">
                    <label for="pp_xx001"><?= lbl_001 ?></label>
                    <input type="text" class="form-control" name="pp_xx001" id="pp_xx001" placeholder="" value="<?= $u5h34r5['xBxD35u'] ?>">
                  </div>
                </div>
              ...
              <div class="row">               
                ...
                <div class="col-sm-12">
                  <input type="hidden" name="mk76id" id="mk76id" value="<?= $u5h34r5['xBxIDu'] ?>">
                  <input type="hidden" name="pp_xx003" id="pp_xx003" value="<?= $u5h34r5['xBxMIDu'] ?>">
