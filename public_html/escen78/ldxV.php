<?php 
include('iDi0m45/'.$iDi['u5h8ir5_iDi'].'/i_ldxV.php');
        ...
        <div class="card-body">
          ...
          <div class="card-body p-0">        
            <?php //if(v4lID44x50("1300-002", $u5u4i0) == TRUE){ /// --- Agregar servicio?>
              <button type="button" data-toggle="modal" data-target="#modal-nuevo" class="btn bg-gradient-success btn-app" style="padding-top: 6px;"@click="app.showingaddModal = true;"><i class="fa-duotone fa-toolbox"></i> <?= btn_46r364rm0Du ?></button>
            <?php //} ?>
                ...
                <table class="table table-hover table-head-fixed table-striped" id="example1">
                  ...
                  <tbody>
                    ...
                    foreach ($LDNT as $xs4f => $P3r70y7) { ?>                   
                      <tr>
                        <td><a href="v75t4?axc0=Tr4V&xDI4Rt=<?= $eCry($P3r70y7['xmCeI']) ?>&xIDS=<?= $eCry($P3r70y7['xmIeD']) ?>&xcIDV3Hs=<?= $eCry($P3r70y7['xmVhe']) ?>" target="_blank"><i class="fa-duotone fa-<?= $P3r70y7['dNIxCo'] ?>"></i> <?= $P3r70y7['xmD3s'] ?></a></td>                        
                        ...
                        <td>
                          <?php if(v4lID44x50("300-003", $u5u4i0) == TRUE){ /// --- Editar Permisos ?>
                            <a href="v75t4?axc0=v3hFh4&vh3iP=<?= $eCry($P3r70y7['xmVhe']) ?>" class="btn btn-block bg-gradient-info btn-xs"><i class="fa-duotone fa-eye"></i></a>
                          <?php } ?>
                        </td>
                      </tr>
                    <?php } ?>
