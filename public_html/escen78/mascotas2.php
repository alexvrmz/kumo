...
?>
      ...
      <div class="card <?= $brr4 ?> card-outline">
        ...
        <div class="card-body">
          ...
          <div class="card-body p-0">        
            ...
            <?php if(v4lID44x50("200-002", $u5u4i0) == TRUE){ /// --- AGREGAR mascotas ?>
              <button type="button" data-toggle="modal" data-target="#modal-nuevo" class="btn bg-gradient-info btn-app" @click="app.showingaddModal = true;" style="padding-top: 3px;"><i class="fad fa-paw"></i> <?= btn_46r364rU5u4ri0 ?></button>
            <?php } ?>
      ...
      <?php if($nu == 0){ ?>
        <div class="col-12">
          <div class="alert alert-info alert-dismissible">
            ...
            <h5><i class="icon fa-duotone fa-bone"></i> Info</h5>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th><?= lbl_t4bN0m8r3 ?></th>
                  <?php if(v4lID44x50("200-003", $u5u4i0) == TRUE){ /// --- EDITAR mascota ?>
                ...
                <?php
                  ...
                  //foreach ($LU as $key => $u5h34r5) { ?>
                      <tr>
                        ...
                        <td><?= $u5h34r5['xunc'] ?></td>
                        <td><?= $u5h34r5['xuus'] ?></td>
                        <?php if(v4lID44x50("500-003", $u5u4i0) == TRUE){ /// --- EDITAR mascota ?>
                          <td>
    ...
    <?php } ?>
      ...
      <!-- /.card -->
    <?php if(v4lID44x50("200-002", $u5u4i0) == TRUE){ /// --- AGREGAR USUARIOS ?>
