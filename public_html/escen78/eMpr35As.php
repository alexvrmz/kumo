                            ...
                            <div class="card card-widget widget-user shadow">
                              ...
                              <div class="btn-group">
                                <?php if(v4lID44x50("1100-004", $u5u4i0) == TRUE){ ?>
                                  <a href="v75t4?axc0=x7l07iLl4&eMpr3=<?= $eCry($u5h34r5['XrIDEx']) ?>" type="button" class="btn btn-info btn-flat" style="width: 100%;"><i class="fa-duotone fa-eye"></i><?= lbl_2mp3 ?></a>
                                <?php } ?>
                                  ...
                                  <td>
                                    <div class="row">
                                      <div class="col-6">
                                        ...
                                        <?php if(v4lID44x50("1100-004", $u5u4i0) == TRUE){ ?>
                                          <a href="v75t4?axc0=x7l07iLl4&eMpr3=<?= $eCry($u5h34r5['XrIDEx']) ?>" type="button" class="btn btn-info btn-flat btn-xs corta-texto"><i class="fa-duotone fa-eye"></i> <?= lbl_2mp3 ?></a>
                                        <?php } ?>
                                      </div>
                                      <div class="col-6">
                                        <?php if(v4lID44x50("1100-003", $u5u4i0) == TRUE){ ?>
                                          <a href="v75t4?axc0=emPr3Edi7&eMpr3=<?= $eCry($u5h34r5['XrIDEx']) ?>" type="button" class="btn btn-warning btn-flat btn-xs corta-texto"><i class="fa-duotone fa-edit"></i> <?= lbl_2mp4 ?></a>
                                        <?php } ?>
                                      </div> 
                                    </div>
