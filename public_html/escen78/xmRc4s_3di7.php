<?php
include('iDi0m45/'.$iDi['u5h8ir5_iDi'].'/i_xmRc4s-3di7.php');
    ...
    <!-- Main content -->
      ...
      <div class="card <?= $brr4 ?> card-outline col-lg-6">
        ...
        <div class="card-body">
          ...
          <form name="edit_user" method="post" action="ap4673i/xmRc4s_4pi.php?accion=xmRc4s_o985" enctype="multipart/form-data">
