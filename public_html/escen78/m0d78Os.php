<?php
include('iDi0m45/'.$iDi['u5h8ir5_iDi'].'/i_m0d78Os.php');
      ...
      <div class="card <?= $brr4 ?> card-outline">
        ...
        <div class="card-body">
          ...
          <div class="card-body p-0">                
            <?php if(v4lID44x50("400-002", $u5u4i0) == TRUE){ /// --- Agregar Modulo?>
              <button type="button" data-toggle="modal" data-target="#modal-nuevo" class="btn bg-gradient-success btn-app" style="padding-top: 6px;"@click="app.showingaddModal = true;"><i class="fa-duotone fa-puzzle-piece"></i> <?= btn_46r364rm0Du ?></button>
            <?php } ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <?php if(v4lID44x50("400-003", $u5u4i0) == TRUE){ /// --- Editar Modulo ?>
                            <a href="v75t4?axc0=m0d7fdDs&m0ft6sV=<?= $eCry($m0Dyg5['m0DxL0_id']) ?>" class="btn btn-block bg-gradient-warning btn-xs"><i class="fa-duotone fa-edit"></i></a>
                          <?php } ?>
                        </td>
                      </tr>
                    <?php } ?>
