...
include('idiomas/'.$iDi['u5h8ir5_iDi'].'/i_asgNv.php');
    ...
    <!-- Main content -->
      ...
      <div class="card <?= $brr4 ?> card-outline col-lg-6">
        <div class="card-header">
          ...
          <form action="ApiPHP/asgNv_4pi.php?accion=svasg" method="POST">
            <div class="card-body">
                      ...
                      <select class="form-control" name="r_001" id="r_001">
                        <option value="nada">Selecciona...</option>
                          <?php foreach ($du as $key => $value) {?>
                              ...
                              <option value="<?= $value['usuarioID'] ?>"><?= $value['u5h8ir5_nombre'] ?> | <?= $value['u5hUS8ir5'] ?> </option>
