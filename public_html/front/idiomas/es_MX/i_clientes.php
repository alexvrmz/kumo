<?php
/// --- Archivo de Idioma es_MX modulo Clientes
define('lbl_7i7uL0','Clientes');
define('lbl_1er7i7u','Acciones');
define('btn_46r364rU5u4ri0','Agregar Cliente');
define('listadoClientes','Lista de Clientes');
define('lbl_t4biD','ID');
define('lbl_t4bN0m8r3','Primer Nombre');
define('lbl_t4bu5u4ri0','Cliente');
define('lbl_t4b3Di74r','Editar');
define('lbl_n3wu5u4ri0','Nueva Cliente');
...
define('nuevoCliente', 'Agregar Cliente');
